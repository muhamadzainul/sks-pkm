...
class Model_pasien extends Model
{
    ...
    protected $allowedFields    = ['nama_pasien', 'slug', 'nik_pasien', 'tgl_lahir', 'jenis_kelamin', 'alamat', 'no_hp', 'email', 'foto_ktp', 'foto_kk', 'publik_key', 'private_key', 'qr_code', 'tanggal_dibuat', 'tanggal_diubah'];
