  ...
  <div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <form class="form-material form-horizontal" action="/petugas/data_pasien/update_data/<?= $data_pasien['id_pasien'];?>" method="post" enctype="multipart/form-data">
              <?= csrf_field();?>
              ...
              <input type="hidden" name="file_kk_lama" value="<?= $data_pasien['foto_kk'];?>">
                ...
                <a href="/petugas/data_pasien/detail_pasien/<?= $data_pasien['slug'];?>" class="btn btn-inverse waves-effect waves-light">Batal</a>
              </form>
          </div>
      </div>
  </div>
