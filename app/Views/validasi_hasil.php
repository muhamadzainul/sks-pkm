...
<div style="background-color: #bbbbbb;" class="wrapper">
    ...
    <div class="white-box w-100">
        <div class="row">
            <div class="col-lg">
                <h3 class="box-title">Hasil Valdasi</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
                ...
                <form action="<?= base_url(); ?>/validasi">
                    <table class="table-borderless table">
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" name="scan_surat" id="scan_surat" class="form-control" value="<?= $data_scan; ?>"></td>
                        </tr>
                        <tr>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="col-md-9">
                    <p class="text-muted"><?= $data_surat['nomor_surat']; ?></p>
                </div> -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img width="20%" alt="qr_code" src="<?php base_url(); ?>/gambar/qr_code/<?= $data_surat['qr_code']; ?>" class="m-t-10">
                    </div>
                </div>
            </div>
