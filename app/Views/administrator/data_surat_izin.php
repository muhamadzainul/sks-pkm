                        ...
                        <table class="table-striped table-hover table-bordered table">
                            ...
                            <tbody>
                                ...
                                <?php if (empty($data_surat)) : ?>
                                    <td colspan="13">
                                        <h5 class="text-grey-500 text-center">Data Surat Izin Belum Ada</h5>
                                    </td>
                                <?php else : ?>
                                    ...
                                    <?php foreach ($data_surat as $ds) : ?>
                                        <tr>
                                            ...
                                            <td><?= $ds['tgl_dibuat']; ?></td>
                                            <!-- <td><a href="<?php base_url(); ?>/admin/surat_izin/detail_surat/<?= $ds['nomor_surat']; ?>" class="btn btn-warning btn-rounded">Detail</a></td> -->
                                            <td><a href="<?php base_url(); ?>/admin/surat_izin/cetak_surat_izin/<?= $ds['nomor_surat']; ?>" class="btn btn-inverse btn-rounded">Cetak</a></td>
                                            <td>
                                                <!-- <a href="" class="btn btn-danger btn-rounded swal_delete" data-hapusId="<?php base_url(); ?>/admin/data_pasien/<?= $ds['id_suratIzin']; ?>">Hapus</a> -->
