        ...
        <div class="white-box">
          ...
          <form class="form-material form-horizontal" action="<?php base_url(); ?>/admin/data_petugas/update_data/<?= $data_petugas['id_satgas']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="nama_petugas" name="nama_petugas" class="form-control" value="<?= (old('nama_petugas')) ? old('nama_petugas') : $data_petugas['nama_petugas']; ?>">
              </div>
            </div>
            <div class="form-group <?= ($validation->hasError('nik_petugas')) ? 'has-error has-danger' : ''; ?>">
              ...
              <div class="col-md-12">
                <input type="number" id="nik_petugas" name="nik_petugas" class="form-control" value="<?= (old('nik_petugas')) ? old('nik_petugas') : $data_petugas['nik_petugas']; ?>">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="number" id="nip_petugas" name="nip_petugas" class="form-control" value="<?= (old('nip_petugas')) ? old('nip_petugas') : $data_petugas['nip_petugas']; ?>">
              </div>
              <div class="help-block with-errors ml-3">
                <ul class="list-unstyled">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="alamat" name="alamat" class="form-control mydatepicker" value="<?= (old('alamat')) ? old('alamat') : $data_petugas['alamat']; ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="email" name="email" class="form-control mydatepicker" value="<?= (old('email')) ? old('email') : $data_petugas['email']; ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="number" id="no_hp" name="no_hp" class="form-control mydatepicker" value="<?= (old('no_hp')) ? old('no_hp') : $data_petugas['no_hp']; ?>">
              </div>
            </div>
            <div class="form-group">
