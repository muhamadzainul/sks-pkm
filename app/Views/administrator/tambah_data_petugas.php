  ...
  <div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <form class="form-material form-horizontal" action="/Admin/data_petugas/simpan" method="post" enctype="multipart/form-data">
              <?= csrf_field();?>
                ...
                <a href="/admin/data_petugas/" class="btn btn-inverse waves-effect waves-light">Cancel</a>
              </form>
          </div>
      </div>
  </div>
