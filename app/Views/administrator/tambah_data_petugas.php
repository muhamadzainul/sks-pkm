        ...
        <div class="white-box">
          ...
          <form class="form-material form-horizontal" action="<?php base_url(); ?>/Admin/data_petugas/simpan" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="nama_petugas" name="nama_petugas" class="form-control" placeholder="Masukkan Nama" value="<?= old('nama_petugas'); ?>">
              </div>
            </div>
            ...
            <a href="<?php base_url(); ?>/admin/data_petugas/" class="btn btn-inverse waves-effect waves-light">Cancel</a>
          </form>
        </div>
      </div>
    </div>
