    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">SKS Puskesmas Dashboard</h4>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="white-box">
                    <div class="r-icon-stats"> <i class="ti-user bg-megna"></i>
                        <div class="bodystate">
                            <h4><?= $total_user; ?></h4> <span class="text-muted">Data Petugas</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="white-box">
                    <div class="r-icon-stats"> <i class="ti-user bg-info"></i>
                        <div class="bodystate">
                            <h4><?= $total_pasien; ?></h4> <span class="text-muted">Data Pasien</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="white-box">
                    <div class="r-icon-stats"> <i class="ti-files bg-success"></i>
                        <div class="bodystate">
                            <h4><?= $total_surat; ?></h4> <span class="text-muted">Data Surat Sehat</span>
                        </div>
                    </div>
                </div>
            </div>
