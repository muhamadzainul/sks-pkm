        ...
        <div class="white-box">
          ...
          <form class="form-material form-horizontal" action="<?php base_url(); ?>/admin/data_pasien/update_data/<?= $data_pasien['id_pasien']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="nama_pasien" name="nama_pasien" class="form-control" value="<?= (old('nama_pasien')) ? old('nama_pasien') : $data_pasien['nama_pasien']; ?>">
              </div>
            </div>
            <div class="form-group <?= ($validation->hasError('nik_pasien')) ? 'has-error has-danger' : ''; ?>">
              ...
              <div class="col-md-12">
                <input type="number" id="nik_pasien" name="nik_pasien" class="form-control" value="<?= (old('nik_pasien')) ? old('nik_pasien') : $data_pasien['nik_pasien']; ?>">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <input type="date" name="tgl_lahir" class="form-control" placeholder="Masukkan Suhu Tubuh" value="<?= (old('tgl_lahir')) ? old('tgl_lahir') : $data_pasien['tgl_lahir']; ?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="alamat" name="alamat" class="form-control mydatepicker" value="<?= (old('alamat')) ? old('alamat') : $data_pasien['alamat']; ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" id="email" name="email" class="form-control mydatepicker" value="<?= (old('email')) ? old('email') : $data_pasien['email']; ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="number" id="no_hp" name="no_hp" class="form-control mydatepicker" value="<?= (old('no_hp')) ? old('no_hp') : $data_pasien['no_hp']; ?>">
              </div>
            </div>
            <div class="form-group">
