...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2022 at 07:43 AM
...
(1, '1-2022', 3516170308990002, 198203102009011011, NULL, 'Karyawan', 179, 45, '34', '110/70', 70, 78, 'TIDAK', 'TIDAK', 'TIDAK', 'Melamar pekerjaan', 'SEHAT', '2b5977a32382f4a02ad3117509052011.png', '2022-01-11', '2022-01-11', '2022-01-13'),
(8, '2-2022', 2344561234561234, 198203102009011011, NULL, 'Karyawan', 179, 68, '34', '110/70', 70, 20, 'TIDAK', 'TIDAK', 'TIDAK', 'Melamar pekerjaan', 'SEHAT', '88e7c81aefae75e8e950a7c127504c86.png', '2022-01-12', '2022-01-12', '2022-01-14');
...
CREATE TABLE `surat_rsa` (
  ...
  `waktu_enkripsi` float DEFAULT NULL,
  `waktu_dekripsi` float DEFAULT NULL,
  `tanggal_dibuat` date DEFAULT NULL,
  `tanggal_diubah` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `pasien`
  MODIFY `id_pasien` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `surat_kesehatan`
  MODIFY `id_sks` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `surat_rsa`
--
ALTER TABLE `surat_rsa`
  MODIFY `id_surat_rsa` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
