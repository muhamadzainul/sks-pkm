...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2022 at 03:34 PM
...
--
ALTER TABLE `surat_kesehatan`
  MODIFY `id_sks` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `surat_rsa`
--
ALTER TABLE `surat_rsa`
  MODIFY `id_surat_rsa` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
